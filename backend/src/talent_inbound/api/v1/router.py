...
from talent_inbound.modules.ingestion.presentation.router import (
    router as ingestion_router,
)
from talent_inbound.modules.opportunities.presentation.router import (
    router as opportunities_router,
)
from talent_inbound.modules.pipeline.presentation.router import (
